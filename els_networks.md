...
possible to understand why ecological networks have the structure we observe.
...
phylogenetic signal of interacting species and trait matching. In contrast, the
...
or cascade of extinctions). Theses extinctions are used to measure the
